...
def pairwise(iterable):
    result_list :list = list(iterable)
    len_list :int = len(result_list)-1
    yield from ((v,None) if i == len_list else (v,result_list[i+1]) for i,v in enumerate(result_list))
